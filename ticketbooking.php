<html>
    <body>
        ...
        $sql = "INSERT INTO TicketConfirmed(name,age,email, gender, source,destination) VALUES ('$name','$age', '$email', '$gender', '$source','$destination','$date','$noOfTickets')";
        }
